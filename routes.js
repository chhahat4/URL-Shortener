...
/*
  @Author : Chhahat Ahlawat
  @Github : https://github.com/chhahat4
...
function sendResponse(req, res) {
    var elem = "<p>" + JSON.stringify({'original_url': req.params.url, 'short_url': 'http://127.0.0.1:5000/sho.rt/this' + req.encodedId}) + "</p>";
    res.send(styles + elem);
}
